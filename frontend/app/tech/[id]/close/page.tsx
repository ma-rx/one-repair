...
import { Wrench, Loader2, AlertCircle, CheckCircle2, Plus, Trash2, FileText, ArrowLeft } from "lucide-react";
...
export default function TechCloseTicketPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex items-center gap-3">
        ...
        <div>
          <p className="font-semibold text-slate-800 text-sm">Close Ticket</p>
              ...
              {partLines.map((line, i) => {
                ...
                return (
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <button type="button" onClick={() => removePartLine(i)} className="text-slate-400 hover:text-red-500">
